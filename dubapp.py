...
def decode_audio(inFile, outFile):
    ...
    """
    inFile= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir/audioFile_0.wav")
    outFile= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir/audioFile_0.wav")
...
def get_transcripts_json(gcsPath, langCode, phraseHints=[], speakerCount=1, enhancedModel=None):
    ...
    audio = Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir/audioFile_0.wav")
...
def parse_sentence_with_speaker(json, lang):
    ...
    """
    json= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/srtPath/TranscribeStr_0")
...
def translate_text(input, targetLang, sourceLang=None):
    ...
    """
    input= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/srtPath/TranscribeStr_0")

    translate_client = translate.Client()
    result = translate_client.translate(
        input, target_language= "en", source_language= "ar")
...
def speak(text, languageCode, voiceName=None, speakingRate=1):
    ...
    """
    text= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/srtPath/TranslationStr_0")
    ...
    if not voiceName:
        ...
        voice = texttospeech.VoiceSelectionParams(
            language_code="en", name=voiceName
        )
...
def stitch_audio(sentences, audioDir, movieFile, outFile, srtPath=None, overlayGain=-30):
    ...
    """
    audioDir= os.path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir")
    x= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir/0.wav")
    movieFile= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir/0.wav")
    tempFile= os.path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/outFile")
    ...
    segments= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir/audioFile_1.mp3")
    dubbed= movieFile
    ...
    audio = x #AudioFileClip(audioFile.name)
...
def dub(
    ...
    videoFile= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/inFile/videoFile.mp4")
    outputDir= os.path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/audioDir")
    srcLang= "ar"
    targetLangs= "en"
    speakerCount= 1
    str= Path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/srtPath/TranslationStr_0")
    voices= "en-GB-Standard-D"
    phraseHints=None
    storageBucket= os.path("/Users/RiceUniversityFinTech./Desktop/FNL_DUBAPP/outFile")
